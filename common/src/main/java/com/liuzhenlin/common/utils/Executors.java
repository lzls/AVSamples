...
/**
 * Various different executors used in AVSamples.
 */
public class Executors {
    ...
    public static final LooperExecutor MAIN_EXECUTOR =
            new LooperExecutor(new Handler(Looper.getMainLooper()));
...
//            new LooperExecutor(createAndStartNewForegroundLooper("UiThreadHelper"));
    ...
    /**
     * An executor used for codecing various formats of media files.
     */
    public static final LooperExecutor MEDIA_CODEC_EXECUTOR =
            new LooperExecutor(createAndStartNewForegroundLooper("MediaCodecLooper"));
